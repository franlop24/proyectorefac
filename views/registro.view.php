...
<header>
    ...
    <div class="contenedor">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="formulario" name="login">
            ...
            <div class="form-group">
                <i class="icono izquierda fa fa-lock"></i><input type="password" name="passwordd" class="password" placeholder="Repetir contraseña">
            </div>
            <div class="form-group">
                <i class="submit-btn" onclick="login.submit()">Registrate</i>
            </div>
<br>
